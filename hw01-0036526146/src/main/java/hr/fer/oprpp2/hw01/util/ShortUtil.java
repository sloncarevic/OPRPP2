...
public class ShortUtil {
	/**
	 * U predani spremnik {@code buf} od pozicije {@code offset} zapisuje dva okteta
	 * u big-endian poretku koja čine 16-bitova predane cjelobrojne varijable
	 * {@code number} koja je tipa {@code short}
	 * 
	...
	/**
	 * Iz predanog spremnika {@code buf} počev od pozicije {@code offset} čita dva
	 * okteta, tumači ih kao oktete cijelog broja tipa {@code short} u formatu
	 * big-endian i rekonstruira taj cijeli broj.
	 * 
